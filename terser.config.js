...
const excludeDirs = ['node_modules', 'dist', '.git', '.vs']; // List of directories to exclude
...
async function updateManifest() {
    try {
        ...
        if (isProduction) {
            ...
            manifest.version = '1.6.3'; // Set version for production
            ...
            manifest.version = '1.6.3'; // Set version for development
